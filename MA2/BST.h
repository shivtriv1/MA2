...
public:
	...
	void printLevelOrder() {
		...
		//for (int i = 0; i < heightCount; levelOrders++) {}
	...
	void printMaxPath() {
		...
		if (this->_root->right != nullptr)
		{
			...
			temp = this->_root->right->value;

			if (this->_root->left != nullptr)
			{
				temp2 = this->_root->left->value;
